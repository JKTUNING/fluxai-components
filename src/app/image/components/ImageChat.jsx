...
export default function ImageChat() {
  return (
    <section id='fluxasset' className='container-fluid px-0 min-h-[900px] pt-[98px]'>
        ...
        <div className='col-xl-7 col-lg-10 col-md-10 col-sm-12 col-12 gap-5 flex flex-col justify-between px-0 lg:px-10'>
          <div className='gap-4 px-3 flex w-full flex-col justify-between'>
            <div className='gap-4 px-3 flex w-full flex-col justify-between'>
              ...
              <h6 className='text-[20px] font-medium leading-5 text-contentTextSecondary'>Generate AI generated images in seconds and display them in your projects.</h6>
            </div>
          </div>
        </div>
      </div>
